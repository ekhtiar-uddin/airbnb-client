  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <button
        ...
        className="px-6 py-3 text-base flex items-center gap-1 text-gray-900 hover:text-gray-700 bg-navActionHoverBg hover:bg-[#ebebeb] transition-colors mt-5 h-[48px] font-bold rounded-xl flex-center cursor-pointer"
      >
